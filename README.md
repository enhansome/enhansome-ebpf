...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,173 | 🐛 16 | 📅 2026-09-14.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - About BPF C and bcc Python helpers, from bcc repository.
...
* [hBPF - eBPF in hardware](https://github.com/rprinz08/hBPF) ⭐ 435 | 🐛 0 | 🌐 Python | 📅 2023-01-27 - An eBPF CPU written for FPGAs.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Comes with bcc, but targets the Python bits across seventeen "lessons".
* [XDP Hands-On Tutorial](https://github.com/xdp-project/xdp-tutorial) ⭐ 2,980 | 🐛 170 | 🌐 C | 📅 2026-05-08 - A progressive (three levels of difficulty) tutorial to learn how to process packets with XDP.
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,969 | 🐛 31 | 🌐 Go | 📅 2026-09-25 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-22 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,823 | 🐛 203 | 🌐 Rust | 📅 2026-09-25 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
...
* [PREVAIL](https://github.com/vbpf/ebpf-verifier) ⭐ 472 | 🐛 39 | 🌐 C++ | 📅 2026-09-19 - A user space verifier for eBPF [using an abstract interpretation layer](https://elazarg.github.io/pldi19main-final.pdf), with support for loops.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,564 | 🐛 339 | 🌐 C | 📅 2026-09-25 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 839 | 🐛 484 | 🌐 C++ | 📅 2026-09-24
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,935 | 🐛 124 | 🌐 Go | 📅 2026-09-24 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,540 | 🐛 396 | 🌐 C++ | 📅 2026-09-24 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,346 | 🐛 44 | 🌐 Makefile | 📅 2026-09-22 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,280 | 🐛 270 | 🌐 Go | 📅 2026-09-21 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 746 | 🐛 185 | 🌐 Go | 📅 2026-09-22 - eBPF based always-on continuous profiler for analysis of CPU and memory usage, down to the line number and throughout time.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,033 | 🐛 287 | 🌐 C | 📅 2026-09-25 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,623 | 🐛 121 | 🌐 Go | 📅 2026-09-15 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,159 | 🐛 41 | 🌐 C | 📅 2026-09-14 - A security monitoring tool. It depends on [SysinternalsEBPF](https://github.com/Sysinternals/SysinternalsEBPF) ⭐ 288 | 🐛 15 | 🌐 C | 📅 2026-09-14.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 68 | 🐛 10 | 🌐 Rust | 📅 2026-09-22 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,823 | 🐛 203 | 🌐 Rust | 📅 2026-09-25 library and built on LSM (Linux Security Module) BPF hooks.
* [BPFJailer](https://github.com/gen0sec/bpfjailer) ⭐ 59 | 🐛 0 | 🌐 C | 📅 2026-09-23 - BpfJailer is an eBPF-based process jailing system that provides mandatory access control (MAC) for Linux.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,163 | 🐛 89 | 🌐 C | 📅 2026-09-25 - sched\_ext schedulers and tools.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,581 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF on Linux.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 5 | 🌐 Rust | 📅 2026-09-25 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 103 | 🐛 6 | 🌐 C | 📅 2026-09-25 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [ebpfkit](https://github.com/Gui774ume/ebpfkit) ⭐ 861 | 🐛 4 | 🌐 C | 📅 2023-02-28 - A rootkit that leverages multiple eBPF features to implement offensive security techniques.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,675 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
