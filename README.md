...
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 849 | 🐛 34 | 🌐 Go | 📅 2026-08-25 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,786 | 🐛 208 | 🌐 Rust | 📅 2026-08-29 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,555 | 🐛 324 | 🌐 C | 📅 2026-08-29 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* [ipx\_wrap](https://github.com/twisted-pear/ipx_wrap) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2026-08-29 - A proof-of-concept IPX implementation for Linux using eBPF.
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,895 | 🐛 117 | 🌐 Go | 📅 2026-08-27 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,525 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,316 | 🐛 44 | 🌐 Makefile | 📅 2026-08-24 - Network, service and security observability for Kubernetes using eBPF.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,962 | 🐛 267 | 🌐 C | 📅 2026-08-28 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,595 | 🐛 121 | 🌐 Go | 📅 2026-08-11 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 58 | 🐛 5 | 🌐 Rust | 📅 2026-08-24 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,786 | 🐛 208 | 🌐 Rust | 📅 2026-08-29 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,139 | 🐛 84 | 🌐 C | 📅 2026-08-28 - sched\_ext schedulers and tools.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-08-28 - A TUI for sniffing network traffic using eBPF on Linux.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,266 | 🐛 29 | 🌐 C | 📅 2026-08-29 - A process-aware, eBPF-based tcpdump-like tool.
...
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 613 | 🐛 23 | 🌐 C | 📅 2026-08-25 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 6 | 🌐 Rust | 📅 2026-08-29 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
