...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,159 | 🐛 14 | 📅 2026-08-12.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - Comes with bcc, but targets the Python bits across seventeen "lessons".
* [XDP Hands-On Tutorial](https://github.com/xdp-project/xdp-tutorial) ⭐ 2,967 | 🐛 170 | 🌐 C | 📅 2026-05-08 - A progressive (three levels of difficulty) tutorial to learn how to process packets with XDP.
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [libbpf](https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.git/tree/tools/lib/bpf) - A C library used for handling BPF objects (programs and maps), and manipulating ELF object files containing them. It is shipped with the kernel and [mirrored on GitHub](https://github.com/libbpf/libbpf) ⭐ 2,753 | 🐛 37 | 🌐 C | 📅 2026-07-30.
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,522 | 🐛 18 | 🌐 CMake | 📅 2026-09-08 - Scaffolding for BPF application development with libbpf and BPF CO-RE.

### Go libraries

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,952 | 🐛 27 | 🌐 Go | 📅 2026-09-10 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-03 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,804 | 🐛 211 | 🌐 Rust | 📅 2026-09-11 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-09-07 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,485 | 🐛 28 | 🌐 Rust | 📅 2026-09-09.
...
* [rbpf](https://github.com/qmonnet/rbpf) ⭐ 1,127 | 🐛 17 | 🌐 Rust | 📅 2026-06-03 - Written in Rust. Interpreter for Linux, macOS and Windows, and JIT-compiler for x86\_64 under Linux.
...
* [PREVAIL](https://github.com/vbpf/ebpf-verifier) ⭐ 470 | 🐛 37 | 🌐 C++ | 📅 2026-09-10 - A user space verifier for eBPF [using an abstract interpretation layer](https://elazarg.github.io/pldi19main-final.pdf), with support for loops.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,561 | 🐛 331 | 🌐 C | 📅 2026-09-11 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* [ipx\_wrap](https://github.com/twisted-pear/ipx_wrap) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2026-09-11 - A proof-of-concept IPX implementation for Linux using eBPF.

* P4 has some interactions with eBPF:

  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 473 | 🌐 C++ | 📅 2026-09-10
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,911 | 🐛 117 | 🌐 Go | 📅 2026-09-07 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
...
* [kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,070 | 🐛 32 | 🌐 C | 📅 2026-09-08 - Kyanos is an eBPF-based network issue analysis tool that enables you to capture network requests, such as HTTP, Redis, and MySQL requests.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,000 | 🐛 278 | 🌐 C | 📅 2026-09-11 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,617 | 🐛 121 | 🌐 Go | 📅 2026-09-10 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 59 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,804 | 🐛 211 | 🌐 Rust | 📅 2026-09-11 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,150 | 🐛 88 | 🌐 C | 📅 2026-09-11 - sched\_ext schedulers and tools.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 189 | 🐛 6 | 🌐 Rust | 📅 2026-09-11 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 99 | 🐛 4 | 🌐 C | 📅 2026-09-11 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,657 | 🐛 1,074 | 🌐 C | 📅 2026-09-11
