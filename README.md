...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,156 | 🐛 13 | 📅 2026-08-12.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,942 | 🐛 24 | 🌐 Go | 📅 2026-09-03 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 849 | 🐛 34 | 🌐 Go | 📅 2026-09-03 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,792 | 🐛 210 | 🌐 Rust | 📅 2026-09-04 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-31 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,485 | 🐛 29 | 🌐 Rust | 📅 2026-09-04.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,555 | 🐛 333 | 🌐 C | 📅 2026-09-03 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,906 | 🐛 121 | 🌐 Go | 📅 2026-09-04 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,322 | 🐛 44 | 🌐 Makefile | 📅 2026-09-03 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,254 | 🐛 270 | 🌐 Go | 📅 2026-09-04 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,982 | 🐛 271 | 🌐 C | 📅 2026-09-04 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,604 | 🐛 124 | 🌐 Go | 📅 2026-09-02 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 59 | 🐛 9 | 🌐 Rust | 📅 2026-09-03 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,792 | 🐛 210 | 🌐 Rust | 📅 2026-09-04 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,145 | 🐛 82 | 🌐 C | 📅 2026-09-04 - sched\_ext schedulers and tools.
* [Gthulhu](https://github.com/Gthulhu/Gthulhu) ⭐ 403 | 🐛 2 | 🌐 Go | 📅 2026-09-03 - Gthulhu optimizes cloud-native workloads using the Linux Scheduler Extension for different application scenarios.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,266 | 🐛 29 | 🌐 C | 📅 2026-09-03 - A process-aware, eBPF-based tcpdump-like tool.
...
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 665 | 🐛 28 | 🌐 C | 📅 2026-09-04 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 6 | 🌐 Rust | 📅 2026-09-04 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
...
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 96 | 🐛 2 | 🌐 C | 📅 2026-09-04 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,653 | 🐛 1,074 | 🌐 C | 📅 2026-08-27
