...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,926 | 🐛 27 | 🌐 Go | 📅 2026-08-24 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 847 | 🐛 34 | 🌐 Go | 📅 2026-08-20 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,783 | 🐛 206 | 🌐 Rust | 📅 2026-08-24 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,476 | 🐛 54 | 🌐 Rust | 📅 2026-08-23.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,549 | 🐛 331 | 🌐 C | 📅 2026-08-22 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,887 | 🐛 116 | 🌐 Go | 📅 2026-08-18 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,312 | 🐛 45 | 🌐 Makefile | 📅 2026-08-23 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,240 | 🐛 269 | 🌐 Go | 📅 2026-08-24 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 57 | 🐛 5 | 🌐 Rust | 📅 2026-08-24 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,783 | 🐛 206 | 🌐 Rust | 📅 2026-08-24 library and built on LSM (Linux Security Module) BPF hooks.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 5 | 🌐 Rust | 📅 2026-08-24 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
