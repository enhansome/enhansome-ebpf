...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,164 | 🐛 13 | 📅 2026-09-14.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,563 | 🐛 331 | 🌐 C | 📅 2026-09-14 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 474 | 🌐 C++ | 📅 2026-09-13
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,915 | 🐛 119 | 🌐 Go | 📅 2026-09-07 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,327 | 🐛 44 | 🌐 Makefile | 📅 2026-09-11 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,264 | 🐛 270 | 🌐 Go | 📅 2026-09-14 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,006 | 🐛 277 | 🌐 C | 📅 2026-09-14 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 59 | 🐛 13 | 🌐 Rust | 📅 2026-09-14 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,810 | 🐛 215 | 🌐 Rust | 📅 2026-09-14 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,152 | 🐛 85 | 🌐 C | 📅 2026-09-14 - sched\_ext schedulers and tools.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,271 | 🐛 29 | 🌐 C | 📅 2026-09-03 - A process-aware, eBPF-based tcpdump-like tool.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 189 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,662 | 🐛 1,077 | 🌐 C | 📅 2026-09-11
