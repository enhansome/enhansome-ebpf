...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,520 | 🐛 18 | 🌐 CMake | 📅 2026-08-31 - Scaffolding for BPF application development with libbpf and BPF CO-RE.

### Go libraries

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,939 | 🐛 24 | 🌐 Go | 📅 2026-09-01 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 849 | 🐛 35 | 🌐 Go | 📅 2026-09-01 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,788 | 🐛 210 | 🌐 Rust | 📅 2026-09-02 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,553 | 🐛 327 | 🌐 C | 📅 2026-08-31 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 836 | 🐛 471 | 🌐 C++ | 📅 2026-09-02
...
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,529 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,320 | 🐛 44 | 🌐 Makefile | 📅 2026-09-01 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,252 | 🐛 268 | 🌐 Go | 📅 2026-08-31 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 743 | 🐛 179 | 🌐 Go | 📅 2026-09-02 - eBPF based always-on continuous profiler for analysis of CPU and memory usage, down to the line number and throughout time.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,979 | 🐛 272 | 🌐 C | 📅 2026-09-02 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,599 | 🐛 124 | 🌐 Go | 📅 2026-09-02 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 58 | 🐛 14 | 🌐 Rust | 📅 2026-09-01 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,788 | 🐛 210 | 🌐 Rust | 📅 2026-09-02 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,143 | 🐛 79 | 🌐 C | 📅 2026-09-01 - sched\_ext schedulers and tools.
* [Gthulhu](https://github.com/Gthulhu/Gthulhu) ⭐ 403 | 🐛 5 | 🌐 Go | 📅 2026-09-02 - Gthulhu optimizes cloud-native workloads using the Linux Scheduler Extension for different application scenarios.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,267 | 🐛 29 | 🌐 C | 📅 2026-09-02 - A process-aware, eBPF-based tcpdump-like tool.
...
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 658 | 🐛 25 | 🌐 C | 📅 2026-08-31 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 5 | 🌐 Rust | 📅 2026-09-02 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
...
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 96 | 🐛 1 | 🌐 C | 📅 2026-08-31 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,649 | 🐛 1,073 | 🌐 C | 📅 2026-08-27
