...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,168 | 🐛 15 | 📅 2026-09-14.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Comes with bcc, but targets the Python bits across seventeen "lessons".
* [XDP Hands-On Tutorial](https://github.com/xdp-project/xdp-tutorial) ⭐ 2,975 | 🐛 170 | 🌐 C | 📅 2026-05-08 - A progressive (three levels of difficulty) tutorial to learn how to process packets with XDP.
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,962 | 🐛 25 | 🌐 Go | 📅 2026-09-17 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-15 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,814 | 🐛 201 | 🌐 Rust | 📅 2026-09-19 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 142 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,488 | 🐛 27 | 🌐 Rust | 📅 2026-09-18.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 474 | 🌐 C++ | 📅 2026-09-18
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,925 | 🐛 119 | 🌐 Go | 📅 2026-09-18 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,536 | 🐛 396 | 🌐 C++ | 📅 2026-07-30 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,339 | 🐛 44 | 🌐 Makefile | 📅 2026-09-15 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,275 | 🐛 271 | 🌐 Go | 📅 2026-09-17 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 746 | 🐛 185 | 🌐 Go | 📅 2026-09-18 - eBPF based always-on continuous profiler for analysis of CPU and memory usage, down to the line number and throughout time.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,018 | 🐛 281 | 🌐 C | 📅 2026-09-19 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 65 | 🐛 11 | 🌐 Rust | 📅 2026-09-19 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,814 | 🐛 201 | 🌐 Rust | 📅 2026-09-19 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,157 | 🐛 86 | 🌐 C | 📅 2026-09-19 - sched\_ext schedulers and tools.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,275 | 🐛 30 | 🌐 C | 📅 2026-09-03 - A process-aware, eBPF-based tcpdump-like tool.
...
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 699 | 🐛 29 | 🌐 C | 📅 2026-09-13 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 6 | 🌐 Rust | 📅 2026-09-19 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 101 | 🐛 6 | 🌐 C | 📅 2026-09-19 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,662 | 🐛 1,075 | 🌐 C | 📅 2026-09-19
