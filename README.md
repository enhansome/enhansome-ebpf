...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,948 | 🐛 26 | 🌐 Go | 📅 2026-09-10 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-03 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,802 | 🐛 210 | 🌐 Rust | 📅 2026-09-10 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
...
* [ipx\_wrap](https://github.com/twisted-pear/ipx_wrap) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2026-09-10 - A proof-of-concept IPX implementation for Linux using eBPF.

* P4 has some interactions with eBPF:

  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 477 | 🌐 C++ | 📅 2026-09-03
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,908 | 🐛 117 | 🌐 Go | 📅 2026-09-07 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,531 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,326 | 🐛 44 | 🌐 Makefile | 📅 2026-09-08 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,260 | 🐛 270 | 🌐 Go | 📅 2026-09-10 - Instant observability for cloud-native and AI applications based on eBPF.
* [Caretta](https://github.com/groundcover-com/caretta) ⭐ 2,061 | 🐛 18 | 🌐 Go | 📅 2025-03-17 - Instant Kubernetes service dependency map generated by eBPF, right to a Grafana instance.
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 743 | 🐛 183 | 🌐 Go | 📅 2026-09-10 - eBPF based always-on continuous profiler for analysis of CPU and memory usage, down to the line number and throughout time.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,997 | 🐛 276 | 🌐 C | 📅 2026-09-10 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,614 | 🐛 121 | 🌐 Go | 📅 2026-09-10 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,158 | 🐛 41 | 🌐 C | 📅 2026-09-09 - A security monitoring tool. It depends on [SysinternalsEBPF](https://github.com/Sysinternals/SysinternalsEBPF) ⭐ 289 | 🐛 15 | 🌐 C | 📅 2026-09-09.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 59 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,802 | 🐛 210 | 🌐 Rust | 📅 2026-09-10 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,148 | 🐛 87 | 🌐 C | 📅 2026-09-10 - sched\_ext schedulers and tools.
* [Gthulhu](https://github.com/Gthulhu/Gthulhu) ⭐ 403 | 🐛 6 | 🌐 Go | 📅 2026-09-05 - Gthulhu optimizes cloud-native workloads using the Linux Scheduler Extension for different application scenarios.

### Tools

* [oryx](https://github.com/pythops/oryx) ⭐ 2,577 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF on Linux.
...
* [bpfman](https://github.com/bpfman/bpfman) ⭐ 764 | 🐛 17 | 🌐 Go | 📅 2026-09-07 - An eBPF Manager for Linux and Kubernetes. Includes a built-in program loader that supports program cooperation for XDP and TC programs, as well as deployment of eBPF programs from OCI images.
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 682 | 🐛 27 | 🌐 C | 📅 2026-09-07 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 6 | 🌐 Rust | 📅 2026-09-10 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 99 | 🐛 4 | 🌐 C | 📅 2026-09-10 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [ebpfkit](https://github.com/Gui774ume/ebpfkit) ⭐ 859 | 🐛 4 | 🌐 C | 📅 2023-02-28 - A rootkit that leverages multiple eBPF features to implement offensive security techniques.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,656 | 🐛 1,077 | 🌐 C | 📅 2026-08-27
