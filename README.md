...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,169 | 🐛 15 | 📅 2026-09-14.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,964 | 🐛 26 | 🌐 Go | 📅 2026-09-17 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-15 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,817 | 🐛 203 | 🌐 Rust | 📅 2026-09-20 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
...
* [uBPF](https://github.com/iovisor/ubpf/) ⭐ 989 | 🐛 17 | 🌐 C | 📅 2026-09-19 - Written in C. Contains an interpreter, a JIT compiler for x86\_64 architecture, an assembler and a disassembler.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 475 | 🌐 C++ | 📅 2026-09-18
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,927 | 🐛 120 | 🌐 Go | 📅 2026-09-18 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
...
* [kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,068 | 🐛 32 | 🌐 C | 📅 2026-09-16 - Kyanos is an eBPF-based network issue analysis tool that enables you to capture network requests, such as HTTP, Redis, and MySQL requests.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,340 | 🐛 44 | 🌐 Makefile | 📅 2026-09-15 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,275 | 🐛 271 | 🌐 Go | 📅 2026-09-20 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,020 | 🐛 283 | 🌐 C | 📅 2026-09-20 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,618 | 🐛 119 | 🌐 Go | 📅 2026-09-15 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 66 | 🐛 11 | 🌐 Rust | 📅 2026-09-19 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,817 | 🐛 203 | 🌐 Rust | 📅 2026-09-20 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,158 | 🐛 88 | 🌐 C | 📅 2026-09-20 - sched\_ext schedulers and tools.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,579 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF on Linux.
* [kubectl trace](https://github.com/iovisor/kubectl-trace) ⭐ 2,187 | 🐛 49 | 🌐 Go | 📅 2026-04-16 - A kubectl plug-in for executing bpftrace programs in a Kubernetes cluster.
* [redbpf](https://github.com/foniod/redbpf) ⚠️ Archived - Tooling and framework to write eBPF code in Rust efficiently.
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,276 | 🐛 30 | 🌐 C | 📅 2026-09-03 - A process-aware, eBPF-based tcpdump-like tool.
* [bpfman](https://github.com/bpfman/bpfman) ⭐ 766 | 🐛 18 | 🌐 Go | 📅 2026-09-14 - An eBPF Manager for Linux and Kubernetes. Includes a built-in program loader that supports program cooperation for XDP and TC programs, as well as deployment of eBPF programs from OCI images.
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 703 | 🐛 29 | 🌐 C | 📅 2026-09-13 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 101 | 🐛 6 | 🌐 C | 📅 2026-09-20 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,666 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
