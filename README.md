...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,170 | 🐛 16 | 📅 2026-09-14.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - About BPF C and bcc Python helpers, from bcc repository.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,965 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-22 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,822 | 🐛 205 | 🌐 Rust | 📅 2026-09-22 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 141 | 🐛 6 | 🌐 Rust | 📅 2026-09-22 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,488 | 🐛 29 | 🌐 Rust | 📅 2026-09-21.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 838 | 🐛 476 | 🌐 C++ | 📅 2026-09-22
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,931 | 🐛 121 | 🌐 Go | 📅 2026-09-21 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,538 | 🐛 396 | 🌐 C++ | 📅 2026-09-22 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
...
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,278 | 🐛 271 | 🌐 Go | 📅 2026-09-21 - Instant observability for cloud-native and AI applications based on eBPF.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,025 | 🐛 283 | 🌐 C | 📅 2026-09-22 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,620 | 🐛 120 | 🌐 Go | 📅 2026-09-15 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 67 | 🐛 10 | 🌐 Rust | 📅 2026-09-22 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,822 | 🐛 205 | 🌐 Rust | 📅 2026-09-22 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,161 | 🐛 85 | 🌐 C | 📅 2026-09-22 - sched\_ext schedulers and tools.
...
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 705 | 🐛 30 | 🌐 C | 📅 2026-09-13 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 5 | 🌐 Rust | 📅 2026-09-22 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 102 | 🐛 6 | 🌐 C | 📅 2026-09-22 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,668 | 🐛 1,078 | 🌐 C | 📅 2026-09-19
