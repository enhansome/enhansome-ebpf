...
> Note: eBPF is an exciting piece of technology, and its ecosystem is constantly evolving. We'd love help from *you* to keep this awesome list up to date, and improve its signal-to-noise ratio in anyway we can. Please feel free to leave [any feedback](https://github.com/qmonnet/awesome-ebpf/issues) ⭐ 5,157 | 🐛 13 | 📅 2026-08-12.
...
* [List of BPF features per kernel version](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27
...
* [A BPF reference guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - About BPF C and bcc Python helpers, from bcc repository.

* [Beginner's guide to eBPF](https://github.com/lizrice/ebpf-beginners) ⭐ 1,731 | 🐛 3 | 🌐 Python | 📅 2023-05-08 - A set of live-coding talks and the accompanying code examples, introducing eBPF programming using a variety of libraries and program types.
...
* [bcc Reference Guide](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Many incremental steps to start using bcc and eBPF, mostly centered on tracing and monitoring.
* [bcc Python Developer Tutorial](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Comes with bcc, but targets the Python bits across seventeen "lessons".
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Examples coming along with the bcc tools, mostly about tracing.
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - These tools themselves can be seen as example use cases for BPF programs, mostly for tracing and monitoring. bcc tools have been packaged for some Linux distributions.
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Framework and set of tools - One way to handle BPF programs, in particular for tracing and monitoring. Also includes some utilities that may help inspect maps or programs on the system.
* [Lua front-end for BCC](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27 - Another alternative to C, and even to most of the Python code used in bcc.
...
* [libbpf](https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.git/tree/tools/lib/bpf) - A C library used for handling BPF objects (programs and maps), and manipulating ELF object files containing them. It is shipped with the kernel and [mirrored on GitHub](https://github.com/libbpf/libbpf) ⭐ 2,751 | 🐛 35 | 🌐 C | 📅 2026-07-30.
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,521 | 🐛 18 | 🌐 CMake | 📅 2026-08-31 - Scaffolding for BPF application development with libbpf and BPF CO-RE.

### Go libraries

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,943 | 🐛 24 | 🌐 Go | 📅 2026-09-03 - Pure-Go library to read, modify and load eBPF programs and attach them to various hooks in the Linux kernel.
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 849 | 🐛 34 | 🌐 Go | 📅 2026-09-03 - eBPF library for Go, powered by libbpf.

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,792 | 🐛 210 | 🌐 Rust | 📅 2026-09-05 - A pure Rust library for writing, loading, and managing eBPF objects, with a focus on developer experience and operability. It supports writing eBPF programs in Rust and distributing library code over crates.io to share it between eBPF programs. Aya does not depend on libbpf.
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-31 - Templates for writing BPF applications in Aya that can be used with [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,484 | 🐛 28 | 🌐 Rust | 📅 2026-09-04.
...
* [PREVAIL](https://github.com/vbpf/ebpf-verifier) ⭐ 470 | 🐛 42 | 🌐 C++ | 📅 2026-08-29 - A user space verifier for eBPF [using an abstract interpretation layer](https://elazarg.github.io/pldi19main-final.pdf), with support for loops.
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,555 | 🐛 334 | 🌐 C | 📅 2026-09-05 - This project is a work-in-progress that allows using existing eBPF toolchains and APIs familiar in the Linux ecosystem to be used on top of Windows.
...
* P4 has some interactions with eBPF:
  ...
  * [P4\_16 backend for eBPF](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 474 | 🌐 C++ | 📅 2026-09-03
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,906 | 🐛 119 | 🌐 Go | 📅 2026-09-04 - Coroot is an open-source APM and observability tool, a DataDog and NewRelic alternative.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,532 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Observability for Kubernetes using eBPF. Features include protocol tracing, application profiling, and support for distributed bpftrace deployments.
* [kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,070 | 🐛 32 | 🌐 C | 📅 2026-09-03 - Kyanos is an eBPF-based network issue analysis tool that enables you to capture network requests, such as HTTP, Redis, and MySQL requests.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,323 | 🐛 44 | 🌐 Makefile | 📅 2026-09-03 - Network, service and security observability for Kubernetes using eBPF.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,254 | 🐛 269 | 🌐 Go | 📅 2026-09-04 - Instant observability for cloud-native and AI applications based on eBPF.
* [Caretta](https://github.com/groundcover-com/caretta) ⭐ 2,059 | 🐛 18 | 🌐 Go | 📅 2025-03-17 - Instant Kubernetes service dependency map generated by eBPF, right to a Grafana instance.
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 743 | 🐛 180 | 🌐 Go | 📅 2026-09-02 - eBPF based always-on continuous profiler for analysis of CPU and memory usage, down to the line number and throughout time.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,985 | 🐛 276 | 🌐 C | 📅 2026-09-05 - Kubernetes-aware, eBPF-based security observability and runtime enforcement.
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,606 | 🐛 124 | 🌐 Go | 📅 2026-09-02 - A runtime security and forensics tool for Linux which uses eBPF technology to trace the system and applications at runtime, and analyze collected events to detect suspicious behavioral patterns.
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,156 | 🐛 42 | 🌐 C | 📅 2026-07-13 - A security monitoring tool. It depends on [SysinternalsEBPF](https://github.com/Sysinternals/SysinternalsEBPF) ⭐ 289 | 🐛 16 | 🌐 C | 📅 2026-05-07.
...
* [Bombini](https://github.com/bombinisecurity/bombini) ⭐ 59 | 🐛 9 | 🌐 Rust | 📅 2026-09-03 - An eBPF-based security agent written entirely in Rust using the [Aya](https://github.com/aya-rs/aya) ⭐ 4,792 | 🐛 210 | 🌐 Rust | 📅 2026-09-05 library and built on LSM (Linux Security Module) BPF hooks.
...
* [scx](https://github.com/sched-ext/scx) ⭐ 2,146 | 🐛 81 | 🌐 C | 📅 2026-09-05 - sched\_ext schedulers and tools.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI for sniffing network traffic using eBPF on Linux.
...
* [ptcpdump](https://github.com/mozillazg/ptcpdump) ⭐ 1,268 | 🐛 29 | 🌐 C | 📅 2026-09-03 - A process-aware, eBPF-based tcpdump-like tool.
* [bpfman](https://github.com/bpfman/bpfman) ⭐ 763 | 🐛 17 | 🌐 Go | 📅 2026-08-31 - An eBPF Manager for Linux and Kubernetes. Includes a built-in program loader that supports program cooperation for XDP and TC programs, as well as deployment of eBPF programs from OCI images.
* [AgentSight](https://github.com/eunomia-bpf/AgentSight) ⭐ 669 | 🐛 28 | 🌐 C | 📅 2026-09-04 - Zero-instrumentation eBPF observability for LLM and coding agents, capturing syscall-level traces (file, network, process) without modifying the agent.
...
* [GhostScope](https://github.com/swananan/ghostscope) ⭐ 188 | 🐛 6 | 🌐 Rust | 📅 2026-09-05 - A DWARF-aware eBPF tracer for source-level userspace tracing, with an interactive TUI and a scriptable CLI.
...
* [ActPlane](https://github.com/eunomia-bpf/ActPlane) ⭐ 97 | 🐛 1 | 🌐 C | 📅 2026-09-05 - OS-level agent harness that compiles a policy DSL to an in-kernel eBPF engine for labeled information-flow control at the syscall boundary, enforcing constraints across any tool or subprocess.
...
* [ebpfkit](https://github.com/Gui774ume/ebpfkit) ⭐ 856 | 🐛 4 | 🌐 C | 📅 2023-02-28 - A rootkit that leverages multiple eBPF features to implement offensive security techniques.
...
* [IO Visor's bcc documentation](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,654 | 🐛 1,074 | 🌐 C | 📅 2026-08-27
